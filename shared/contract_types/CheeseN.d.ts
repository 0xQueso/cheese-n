...
interface CheeseNInterface extends ethers.utils.Interface {
  functions: {
    "MAX_N_TOKEN_ID()": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "finalizeCircle(uint256,uint256,uint256,uint256)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "getCxPosition(uint256,uint256,uint256,uint256)": FunctionFragment;
    "getCyPosition(uint256,uint256,uint256,uint256)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "joinString(string,uint256,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "finalizeCircle",
  ...
  encodeFunctionData(
    functionFragment: "getCxPosition",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getCyPosition",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "joinString", data: BytesLike): Result;
...
export class CheeseN extends BaseContract {
